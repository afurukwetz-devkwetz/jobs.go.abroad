...
async function seedDefaultTemplates() {
  try {
    ...
    const initialTemplates = [
      ...
      // ─── Payments ────────────────────────────────────────────────────────────────
      {
        category: 'Payments', name: 'Fee Explanation – Brief (Option A)',
        subject: 'Important: Application Processing Fee Notice | Ref: [Application ID]',
        body: 'Dear [Applicant Name],\n\nThank you for applying through Global Job Connect. We would like to inform you that a one-time, non-refundable application processing fee is required to complete your registration. This fee covers credential verification, professional profile preparation, employer matching across the UK, USA, Canada, Germany, and Australia, and ongoing administrative support throughout your recruitment process — ensuring only serious, committed candidates enter our placement pool.\n\nThe fee is fully transparent and will be clearly disclosed before any payment is required — no hidden charges, no surprises. Once the fee is processed, you will receive a unique Reference Number to track the live status of your application at any time through our secure Applicant Portal. Should you have any questions, please contact us at support@globaljoconnect.online.\n\nKind regards,\n[HR Officer]\nGlobal Job Connect\nLicense: NEA-2025-0192\nsupport@globaljoconnect.online'
      },
      {
        category: 'Payments', name: 'Fee Explanation – Detailed (Option B)',
        subject: 'Application Processing Fee – Full Policy Notice | Ref: [Application ID]',
        body: 'Dear [Applicant Name],\n\nAt Global Job Connect, we are committed to connecting talented nursing, caregiving, and skilled trade professionals with life-changing international job opportunities. To facilitate this, a one-time, non-refundable application processing fee is collected from all applicants upon registration. This fee enables us to dedicate the necessary time and resources to properly evaluate your qualifications, verify your submitted documents, and professionally match your profile with accredited employers in your destination country of choice.\n\nThe funds from this fee directly support the services you receive throughout the recruitment process — including employer outreach, interview scheduling, visa guidance, and real-time application tracking through our secure Applicant Portal. We operate under Government License No. NEA-2025-0192, and all collected fees are handled in full compliance with our regulatory obligations. Every applicant is treated with the highest standard of professionalism and care.\n\nYour fee amount will be clearly disclosed at the next stage of the process — before any payment is requested — ensuring complete transparency at all times. Please note that the processing fee is non-refundable once your application has been accepted into the recruitment pool, and payment does not guarantee employment, visa approval, or placement, as these decisions rest with employers and the relevant licensing and immigration authorities. Should you have any questions about the fee or how it applies to your application, please do not hesitate to contact us at support@globaljoconnect.online. We look forward to helping you take your next big step — Work Anywhere. Grow Everywhere.\n\nKind regards,\n[HR Officer]\nGlobal Job Connect\nLicense: NEA-2025-0192\nsupport@globaljoconnect.online'
      },
      {
